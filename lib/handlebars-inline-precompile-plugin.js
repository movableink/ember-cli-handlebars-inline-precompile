...
module.exports = function (Handlebars) {
  return function (babel) {
    ...
    var compile = function (node, template, hbs, get) {
      ...
      var resolvePath = Handlebars.JavaScriptCompiler.prototype.resolvePath;
      Handlebars.JavaScriptCompiler.prototype.resolvePath = function (type, parts, i, falsy, strict) {
        if (this.options.strict || this.options.assumeObjects) {
          return resolvePath.call(this, type, parts, i, falsy, strict);
        }

        if (type === 'context') {
          var top = this.popStack(true);
          let stack = [top.value];
          let lookup = this.nameLookup(stack, parts.join('.'), type);
          let path = ['(', stack, ' != null ? ', lookup, ' : ', stack, ')'];
          this.push(path);
        } else {
          resolvePath.call(this, type, parts, i, falsy, strict);
        }
      };
      ...
      Handlebars.JavaScriptCompiler.prototype.resolvePath = resolvePath;
